%test sortFileList
function tests = sortFileList2Test
...
validList = { 'Group2_Subject 2 _ Week3'; 'Group 1_Subject1_Week2';...
    'Group1_Subject1_Week10';'Group 1_Subject1_Baseline';...
...
verifyError(testCase,@() sortFileList2(badList), expErr);
verifyError(testCase,@() sortFileList2(NaN), expErr);
